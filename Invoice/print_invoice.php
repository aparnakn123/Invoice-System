...
if(isset($_GET["pdf"]) && isset($_GET["id"]))
{
 ...
 foreach($result as $row)
 {
  ...
  {
   $count++;
   $totaltaxamount += $sub_row["order_item_actual_amount"]+$sub_row["order_item_tax1_amount"];
   $output .= '
   <tr>
    <td>'.$count.'</td>
  ...
  <tr>
   <td colspan="9">Discount Amt. :</td>
   <td align="right">'.$row["order_total_tax2"].'</td>
  </tr>
  <tr>
   <td colspan="9"><b>Final Amt. :</b></td>
